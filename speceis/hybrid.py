...
class CoupledModel:
    def __init__(
        ...
        elif sliding_law == 'generalized':
            basal_stress = -gamma/vel_scale*beta2*df.dot(U_b/(df.norm(U_b) + df.Constant(1e-3)),Phi_b)*df.dx#degree=4)
        ...
        self.U_s = df.Function(V_proj,name='U_s')
